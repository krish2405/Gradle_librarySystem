...
public class QueryOperation {
    public static final String CREATE_TABLE = "CREATE TABLE IF NOT EXISTS adminuser (name VARCHAR(50), Password VARCHAR(50), age INT, DOB DATE, Signup_date DATE, Modification_date DATE, email VARCHAR(50), isadmin BOOLEAN)";
    public static final String LOGIN = "SELECT isadmin FROM adminuser WHERE name = ? AND Password = ?";
